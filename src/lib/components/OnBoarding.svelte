			...
			<div class="flex flex-col justify-end w-full items-center pb-10 text-center">
				<div class="text-5xl lg:text-7xl font-secondary">
					<Marquee
						duration={5000}
						words={[
							$i18n.t('Soar through the skies'),
							$i18n.t('Navigate the clouds'),
							$i18n.t('Pilot your journey'),
							$i18n.t('Experience flight freedom'),
							$i18n.t('Discover aerial wonders'),
							$i18n.t('Command the cockpit'),
							$i18n.t('Cross flight boundaries'),
							$i18n.t('Master aviation skills'),
							$i18n.t('Conquer the airways'),
							$i18n.t('Embrace aerial adventures')
						]}
					/>
