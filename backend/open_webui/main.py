...
# Add library router with detailed logging
try:
    log.info(f"Registering library router at: /api/v1/library")
    app.include_router(library.router, prefix="/api/v1/library", tags=["library"])
    log.info(f"Library router registered successfully")
except Exception as e:
    log.error(f"Error registering library router: {e}")
...
async def get_manifest_json():
    if app.state.EXTERNAL_PWA_MANIFEST_URL:
        ...
        return {
            ...
            "description": "Caa AI is an open, extensible, user-friendly interface for AI that adapts to your workflow.",
            "start_url": "/",
            "display": "standalone",
